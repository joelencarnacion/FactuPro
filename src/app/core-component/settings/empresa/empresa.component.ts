...
import { EmpresaI, MonedaI, NumEmpleadosI, RegimenI, ResponseI, SectorI, UsuarioActualI } from '../../../interfaces/allinterfaces';
...
export class EmpresaComponent implements OnInit {
  ...
  constructor(
    ...
    this.empresaForm = this.fb.group({
      ...
      idMoneda: new FormControl<number>(0,[Validators.required]),
  ...
  getMoneda(){
    this.empresaservice.getMoneda().subscribe((resp:ResponseI)=>{
      this.monedasList = resp.data;
    })
  }
  ...
  getEmpresaById(){
    this.empresaservice.getEmpresaById(this.idEmpresa).subscribe((resp: ResponseI) => {
      ...
      this.empresaForm.patchValue({
        ...
        idMoneda: this.empresa.idMoneda,
  ...
  enviarDatos(): void {
    ...
    formData.append('IdMoneda', this.empresaForm.get('idMoneda')!.value);

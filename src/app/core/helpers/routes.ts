export class routes {
  ...
  public static get daningTable(): string {
    return this.core + '/dining-table';
  }
  public static get posOrders(): string {
    return this.core + '/pos-orders';
  }
  public static get offers(): string {
    return this.core + '/offers';
  }
  public static get administrators(): string {
    return this.core + '/administrators';
  }
  public static get customers(): string {
    return this.core + '/customers';
  }
  public static get employees(): string {
    return this.core + '/employees';
  }
  ...
  public static get itemsReport(): string {
    return this.core + '/items-report';
  }
  ...
  public static get tableOrders(): string {
    return this.core + '/table-orders';
  }
  ...
  public static editProduct(id: number): string {
  ...
  public static get marcas(): string {
    return this.settings + '/marcas';
  }
  ...
  public static get impuestos(): string {
    return this.settings + '/impuestos';
  }

  public static get empresa(): string {
    return this.settings + '/empresa';
  }
